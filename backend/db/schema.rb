...
ActiveRecord::Schema[7.0].define(version: 2023_11_20_155058) do
  ...
  create_table "projects", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.text "last_year_sales_revenue_en"
    t.text "last_year_sales_revenue_es"
    t.text "last_year_sales_revenue_pt"
