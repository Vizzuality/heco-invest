...
RSpec.describe "API V1 Project Developers", type: :request do
  ...
  path "/api/v1/project_developers" do
    ...
    post "Create new Project Developer" do
      tags "Project Developers"
      ...
      response "200", :success do
        ...
        it "matches snapshot", generate_swagger_example: true do
          expect(response.body).to match_snapshot("api/v1/create-project-developer", dynamic_attributes: %w[picture_url])
        end
      end
      ...
      response "422", "User already have account" do
        ...
        before(:each) do
          user.update! account: @project_developer.account
          sign_in user
        end
