    ...
    get "Returns list of the projects" do
      ...
      response "200", :success do
        ...
        context "with relationships" do
          ...
          it "matches snapshot" do
            expect(response.body).to match_snapshot("api/v1/projects-include-relationships", dynamic_attributes: %w[picture_url])
          end
        end
      end
    end
    ...
    get "Find project by id or slug" do
      ...
      response "200", :success do
        ...
        context "with relationships" do
          ...
          it "matches snapshot" do
            expect(response.body).to match_snapshot("api/v1/get-project-include-relationships", dynamic_attributes: %w[picture_url])
          end
        end
      end
    end
