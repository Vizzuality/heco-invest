    ...
    <>
            ...
            <div className="mt-8">
              <dl className="space-y-10 md:grid md:grid-cols-2 md:gap-x-6 md:gap-y-16 md:space-y-0">
                <div>
                  ...
                  <dd className="mt-1 text-black/70">
                    <Link href="/discover/project-developer">
                      <a className="font-bold underline text-green-dark">Call on our community</a>
                    </Link>{' '}
                ...
                <div>
                  ...
                  <dd className="mt-1 text-black/70">
                    Find opportunities that have the greatest impact on challenges like
                    biodiversity, climate, community and water.
                  </dd>
                </div>
                <div>
                  <dt className="text-base font-semibold sm:text-lg md:text-xl">
                  ...
                  <dd className="mt-1 text-black/70">
                    Set your priorities and HeCo Invest will connect you with the best
                    opportunities.
                  </dd>
                </div>
                <div>
        ...
        <div className="relative mt-20 lg:mt-52 md:grid md:grid-cols-2 md:gap-3 lg:items-center">
          <div className="relative mt-12 lg:mt-0">
            ...
            <div className="mt-8">
              <dl className="space-y-10 md:grid md:grid-cols-2 md:gap-x-6 md:gap-y-16 md:space-y-0">
                <div>
                  <dt className="text-base font-semibold sm:text-lg md:text-xl">Guiding tools</dt>
                  <dd className="mt-1 text-black/70">
                    Access user-friendly tools that help turn a good idea into a proposal ready to
                    be reviewed by an investor or funder.
                  </dd>
                </div>
                <div>
                  <dt className="text-base font-semibold sm:text-lg md:text-xl">
                  ...
                  <dd className="mt-1 text-black/70">
                    Find other people with similar interests. Join forces, secure more investment
                ...
                <div>
                  ...
                  <dd className="mt-1 text-black/70">
                    Explore our curated database featuring the contacts you need to take your
                    project or business to the next level.
                  </dd>
                </div>
                <div>
                  <dt className="text-base font-semibold sm:text-lg md:text-xl">
                  ...
                  <dd className="mt-1 text-black/70">
                    <Link href="/discover/open-call">
                      <a className="font-bold underline text-green-dark">Browse the open calls</a>
                    </Link>{' '}
        ...
        <LayoutContainer>
          ...
          <div className="grid grid-rows-3 gap-6 mt-12 md:mt-20 md:grid-rows-none md:grid-cols-3">
            <div className="px-6 py-6 text-center md:py-10 bg-green-light/20 rounded-4xl">
              ...
              />
              <h3 className="mt-4 text-xl font-medium uppercase md:mt-14">Search and find</h3>
            ...
            <div className="px-6 py-6 text-center md:py-10 bg-green-light/20 rounded-4xl">
              <Icon
                ...
                className="w-24 h-24 p-3 mx-auto bg-white rounded-full text-green-dark"
              />
              <h3 className="mt-4 text-xl font-medium uppercase md:mt-14">Connect</h3>
              <p className="mt-2 md:mt-2.5 text-black/70">
            ...
            <div className="px-6 py-6 text-center md:py-10 bg-green-light/20 rounded-4xl">
              <Icon
                ...
                className="w-24 h-24 p-3 mx-auto bg-white rounded-full text-green-dark"
              />
              <h3 className="mt-4 text-xl font-medium uppercase md:mt-14">Report back</h3>
              <p className="mt-2 md:mt-2.5 text-black/70">
                Inspire and educate other users by coming back to the platform and updating us on
                your progress. We’ll be able to track the Amazon’s improvement thanks to your
                contribution!
              </p>
            </div>
          </div>
          ...
          <div className="bottom-0 w-full max-w-5xl mt-8 md:mt-0 md:px-8 xl:px-0 md:absolute left-1/2 md:-translate-x-1/2 md:translate-y-1/2">
            <div className="grid grid-rows-2 gap-8 md:grid-rows-none md:grid-cols-2">
              <div className="p-3 md:p-5 lg:p-10 pt-[40%] md:pt-[40%] lg:pt-[40%] bg-white bg-top bg-contain bg-no-repeat bg-[url('/images/home-priority-geographies.jpg')] rounded-2xl shadow-lg">
                <h3 className="text-xl font-medium uppercase">Geographies</h3>
              ...
              <div className="p-3 md:p-5 lg:p-10 pt-[40%] md:pt-[40%] lg:pt-[40%] bg-white bg-top bg-contain bg-no-repeat bg-[url('/images/home-priority-categories.jpg')] rounded-2xl shadow-lg">
                <h3 className="text-xl font-medium uppercase">Categories</h3>
                <p className="mt-2 md:mt-4 text-black/70 lg:leading-8">
                  You can choose from a variety of opportunities that range from sustainable
                  landscape management tools and solutions, to forest-friendly products and business
                  models. From social welfare solutions, to climate solutions and sustainable
                  businesses.
                </p>
              </div>
            </div>
      ...
      <LayoutContainer className="mt-24 lg:mt-48">
        ...
        <p className="max-w-md mx-auto mt-4 text-base text-center md:mt-8 sm:max-w-xl md:max-w-5xl sm:text-lg md:text-xl">
          Through accessing <span className="font-semibold">ARIES</span> (Artificial Intelligence
          for Environmental Sustainability) and using Machine Reasoning modelling algorithms, this
      ...
      <div className="bg-green-dark bg-cover bg-center bg-[url('/images/home-hero.jpg')]">
        <LayoutContainer className="py-16 text-center text-white sm:pt-24 sm:pb-20">
          <h2 className="font-serif text-3xl font-bold md:text-4xl">Start making an impact now!</h2>
          <div className="grid max-w-5xl grid-rows-2 gap-4 mx-auto mt-12 text-base md:mt-16 md:grid-rows-none md:grid-cols-2 md:gap-6 sm:text-lg md:text-xl">
            ...
            <p className="px-4">
              Promote your idea, project or business and connect it with investors and funding
              sources to generate impact in the Amazon region.
            </p>
          </div>
